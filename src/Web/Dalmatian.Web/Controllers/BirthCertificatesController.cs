namespace Dalmatian.Web.Controllers
{
    ...
    public class BirthCertificatesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            if (!await this.birthCertificatesService.DoesIdExits(id).ConfigureAwait(false))
            {
                return this.NotFound();
            }
...
#pragma warning disable CA1062 // Validate arguments of public methods
            if (!await this.birthCertificatesService.DoesIdExits(input.Id).ConfigureAwait(false))
#pragma warning restore CA1062 // Validate arguments of public methods
            {
                return this.NotFound();
            }

            await this.birthCertificatesService.UpdateBirthCertificate(input).ConfigureAwait(false);
