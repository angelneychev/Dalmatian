namespace Dalmatian.Web.Controllers
{
    ...
    public partial class ContactsController : BaseController
    {
        ...
        public async Task<IActionResult> Index(ContactFormViewModel model)
        {
            ...
            await this.contactsRepository.AddAsync(contactFormEntry).ConfigureAwait(false);
            await this.contactsRepository.SaveChangesAsync().ConfigureAwait(false);
            ...
            await this.emailSender.SendEmailAsync(
                ...
                model.Title,
                model.Content).ConfigureAwait(false);
