namespace Dalmatian.Data.Seeding
{
    ...
    public class KennelSeeder : ISeeder
    {
        public async Task SeedAsync(ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            {
                ("Spotmaniac","01215/02", "2000-04-05 18:05:55","BG", "Sofia", "elena@gmail", 1),
                ("Divalinor","01815/00", "2001-07-05 18:05:55","BG", "Varna", "maria@gmail", 2),
                ("Dalmagic","01932/04", "2004-02-05 18:05:55","BG", "Sofia", "ivan@gmail", 3),
                ("Just Coffee","020132/06", "2006-06-05 18:05:55","BG", "Plovdiv", "ekaterina@gmail", 4),
            };
